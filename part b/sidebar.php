  <aside class="main-sidebar sidebar-dark-warning elevation-4" style="background-color: #4a694b">
    <div class="dropdown" style="background-color: #4a694b">
   	<a href="./" class="brand-link" style="background-color: #4a694b">
    ...
    <div class="sidebar pb-4 mb-4" style="background-color: #4a694b">
      <nav class="mt-2">
